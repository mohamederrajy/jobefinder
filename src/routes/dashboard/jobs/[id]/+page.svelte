            ...
            <div class="job-header-content">
              ...
              <div class="job-meta">
                ...
                <div class="meta-item posted">
                  ...
                  <span>Posted {formatDaysAgo(job?.createdAt || '')}</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="similar-jobs-list">
                    {#if similarJobs.length > 0}
                      {#each similarJobs.slice(0, 3) as similarJob, i}
                        <div class="similar-job-card" class:blurred={!$subscription?.subscription?.isPaid && i > 0}>
                            ...
                            <div class="job-card-header">
                              ...
                              <div class="job-card-info">
                                <div class="title-section">
                                  ...
                                  <span class="company-name">{similarJob.company}</span>
                                </div>
                                <div class="job-meta">
                                  <div class="meta-item">
